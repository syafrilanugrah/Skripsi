...
class Data_kelas extends CI_Controller {
    ...
    public function datatable() {
        ...
        $q_datanya = $this->db->query("SELECT * FROM m_kelas join m_jurusan on m_kelas.jurusan_id = m_jurusan.id WHERE m_kelas.nama LIKE '%".$search['value']."%' ORDER BY m_kelas.id DESC LIMIT ".$start.", ".$length."")->result_array();
        $data = array();
        $no = ($start+1);
